 ...
 *  Method:                                                                   *
 *      Iteratively apply Newton's method with the guess t0 = t - rho.        *
 ******************************************************************************
 *  Author: Ryan Maguire                                                      *
 *  Date:   2025/09/20                                                        *
 ******************************************************************************/
...
double past_newton(double rho, double time, unsigned int iters)
{
    ...
    /*  Variable for indexing over the loop for Newton's method.              */
    unsigned int ind;

    /*  Loop through and iteratively apply Newton's method.                   */
    for (ind = 0; ind < iters; ++ind)
        tn = newton(rho, time, tn);
