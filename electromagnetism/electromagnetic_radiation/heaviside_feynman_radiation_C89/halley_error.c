 ...
 *      iters (unsigned int):                                                 *
 *          The number of iterations used for Halley's method.                *
 *  Output:                                                                   *
 *      error (double):                                                       *
 ...
 *      heaviside_feynman.h:                                                  *
 *          past_halley:                                                      *
 *              Computes retarded time (past time) using Halley's method.     *
 *          distance:                                                         *
...
/*  Function for computing the error in Halley's method.                      */
double halley_error(double rho, double time, unsigned int iters)
{
    /*  Use Halley's method to compute the retarded time.                     */
    const double retarded_time = past_halley(rho, time, iters);
    ...
    /*  Retarded time is tr = t - (1 / c) || r(tr) - rho(t) ||. If Halley's   *
